...
BRAND_ASSOCIATION = {
    ...
    "galaxy buds plus": "samsung", 
    "galaxy buds2": "samsung",
    "galaxy fold": "samsung",
    "galaxy flip": "samsung",
    "multiple cameras": "samsung",
    "quad camera": "samsung",
...
# API 질문 템플릿
QUESTIONS = {
    "category": "Identify the single most appropriate item type.",
    "color": "State the primary color of the object.",
    "material": "Specify the main material of the object.",
    "distinctive_features": "Describe one unique characteristic of the object.",
    "brand": "Identify the most likely brand associated with this object.",
}
