...
def fetch_lost_items_from_mysql(limit=100):
    """
    MySQL에서 분실물 데이터를 가져옴
    
    Args:
        limit (int): 가져올 최대 항목 수
    ...
    try:
        ...
        connection = pymysql.connect(
            ...
            database=os.getenv('MYSQL_DB', 'lostfound_db'),
            charset='utf8mb4',
        ...
        with connection:
            with connection.cursor() as cursor:
                ...
                logger.info(f"MySQL에서 {len(lost_items)}개의 분실물 데이터를 가져왔습니다.")
                return lost_items
...
async def find_similar_items_api(
    ...
    try:
        ...
        lost_items = fetch_lost_items_from_mysql(limit=100)
