...
# GPU 설정
# CUDA_DEVICE_ORDER는 GPU 디바이스 순서 지정 방식 (PCI_BUS_ID는 시스템의 PCI 버스 ID 순서대로 디바이스 나열)
...
if __name__ == "__main__":
    ...
    # 유사한 게시글 찾기
    similar_posts = system.find_similar_posts(new_post, existing_posts, threshold=0.65)
